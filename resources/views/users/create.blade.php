        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('adminlte::factory.titles.Add User') }}</h5>
                    <button id="modalClose" type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <form id="modalCreateForm" method="post" action="{{ route("users.store") }}" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <ul class="nav nav-tabs" id="tabEdit" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tabCreate1" role="tab" aria-controls="profile">
                                    <i class="fas fa-address-card"></i> {{  __('adminlte::factory.forms.Profile') }}
                                </a>
                            </li>
                        </ul>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 border-right d-flex flex-column justify-content-center align-items-center">
                                                <div class="d-flex flex-column align-items-center text-center py-4">
                                                    <img id="imagemPreview" class="rounded-circle mt-0" src="/images/users/photo.png" width="150" height="150">
                                                </div>
                                                        ...
                                                        <div class="col-12 col-12 col-md-12 col-lg-12 col-xl-12">
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control @error('name')  is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="Nome" required>
                                                                    @if($errors->has('name'))
                                                        ...
                                                        <div class="col-6 col-6 col-md-6 col-lg-6 col-xl-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="password" class="form-control @error('password2')  is-invalid @enderror" id="password2" name="password2" value="{{ old('password2') }}"
